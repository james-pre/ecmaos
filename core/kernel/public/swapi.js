...
const jo = "@ecmaos/swapi", Yo = "0.1.1", $o = "EcmaOS Service Worker API", Uo = "Jay Mathis <code@mathis.network>", _o = "module", qo = { dev: "vite dev", build: "vite build", "install:kernel": "npm run build && cp dist/swapi.js ../kernel/public/" }, Zo = { "@ecmaos/config-typescript": "workspace:^", vite: "^6.0.1" }, Xo = { typescript: "^5.4.0" }, Qo = { "@faker-js/faker": "^9.1.0", hono: "^4.6.7" }, el = { access: "public" }, Ze = {
  name: jo,
  version: Yo,
  description: $o,
  author: Uo,
...
Je.get("/fs/:file{.*}", async (e) => {
  ...
  try {
    const i = await n, t = {
      ...
      css: "text/css",
      html: "text/html"
    }[a.split(".").pop()] || "application/octet-stream";
